...
npm start Runs the app in the development mode. Open http://localhost:5174 to view it in the browser.
...
All the data was fetched from The Movie Database API: https://developer.themoviedb.org/reference/intro/getting-started
